...
object sparkSql1 {
  ...
  def main(args:Array[String]): Unit = {
    ...
    val data = spark.sparkContext.textFile(path = "E:/dataset_Holidays.txt")
...
//Create Transport Details DF by loading the Transport_Details file
    ...
    val transportDetailsDF = spark.sparkContext.textFile(path = "E:/dataset_Transport.txt").
    ...
    val userDetailsDF = spark.sparkContext.textFile(path = "E:/dataset_Userdet.txt").
  ...
  //Task 1.2 : What is the total air distance covered by each user per year
    ...
    //Approach 2: By joinging two DFs
